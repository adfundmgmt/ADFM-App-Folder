...
CATEGORIES: Dict[str, Dict[str, List[str]]] = {'Information Technology': {'Semiconductors Broad': ['NVDA',
 ...
 'Asia': {'Japan': ['EWJ', 'DXJ'],
          ...
          'Taiwan AI ODM and Thermal': ['2382.TW', '3231.TW', '6669.TW', '3017.TW', '2356.TW', '2317.TW'],
          'Korea Shipbuilding and Defense': ['009540.KS',
                                             '329180.KS',
                                             '042660.KS',
                                             '010140.KS',
                                             '012450.KS',
                                             ...
                                             '079550.KS',
                                             '047810.KS'],
          'Korea Power Equipment': ['267260.KS',
                                    '298040.KS',
                                    '010120.KS',
                                    '006260.KS',
                                    '000500.KS',
                                    '103590.KS',
                                    '001440.KS'],
          'India Defense and Capital Goods': ['HAL.NS',
                                              'BEL.NS',
                                              'MAZDOCK.NS',
                                              'COCHINSHIP.NS',
                                              'LT.NS',
                                              'BHEL.NS',
                                              'ABB.NS'],
          'India Power and Grid Equipment': ['CGPOWER.NS',
                                             'POWERINDIA.NS',
                                             'SIEMENS.NS',
                                             'CUMMINSIND.NS',
                                             'SUZLON.NS',
