...
st.sidebar.markdown(
    ...
    **Features:**
    ...
    Hover to inspect values—zoom/pan enabled.
    """
)
...
# strip tz, trim window, drop weekends
...
# only plot MAs that fit in the trimmed window
n = len(df)
...
for w,col in zip(available_mas, ("purple","blue","orange","gray")):
    fig.add_trace(
        go.Scatter(
