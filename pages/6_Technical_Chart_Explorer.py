...
# Pull a little extra for MA calculation
if period != "max":
...
# Create a categorical x-axis label
...
# Only plot MAs with enough data
...
# ── Force every x‐axis to categorical so weekends stay removed ─────────────
