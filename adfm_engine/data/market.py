"""Reusable daily market-data contract for the native ADFM engine.
...
from adfm_engine.observability import record_data_load
...
@ttl_cache(seconds=DEFAULT_CONFIG.cache_ttl_seconds, max_entries=128)
