...
TOOL_CATALOG: Final[tuple[ToolDefinition, ...]] = (
    ...
    ToolDefinition(20, "Relative Volatility Lab", "20_Relative_Volatility_Lab.py", "Technicals + Analogs", "Compares selectable assets using realized volatility, volatility ratios, causal z-scores, percentiles, and an optional implied-volatility overlay.", "Yahoo Finance adjusted close history; optional implied-volatility index"),
)
