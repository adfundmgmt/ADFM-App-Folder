...
TOOL_CATALOG: Final[tuple[ToolDefinition, ...]] = (
    ...
    ToolDefinition(4, "Yield Curve Rates Regime Monitor", "4_Yield_Curve_Rates_Regime_Monitor.py", "Macro Regime", "Tracks outright U.S. Treasury yield levels, curve shape, and bull/bear steepener or flattener regimes across multiple horizons.", "Yahoo Finance Treasury yields; Federal Reserve / FRED constant-maturity yields on provider failure"),
