...
TOOL_CATALOG: Final[tuple[ToolDefinition, ...]] = (
    ...
    ToolDefinition(8, "Equity Leadership & Rotation", "8_Factor_Momentum_Leadership.py", "Equity Leadership", "Ranks 25 equity relationships across four horizons to identify established leadership, positive inflections, weakening trends, and persistent laggards.", "Yahoo Finance adjusted ETF prices"),
    ...
    ToolDefinition(11, "Cross-Asset Ratio Chartbook", "11_Ratio_Charts.py", "Technical Confirmation", "Provides focused and grouped historical inspection of 50 cross-asset, macro, thematic, and single-stock ratios, plus custom relationships.", "Yahoo Finance adjusted close history"),
