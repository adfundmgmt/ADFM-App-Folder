...
TOOL_CATALOG: Final[tuple[ToolDefinition, ...]] = (
    ...
    ToolDefinition(21, "SEC 13F Exposure Browser", "21_SEC_13F_Exposure_Browser.py", "Flows + Sentiment", "Ranks institutional managers by a selected security's share of their disclosed Form 13F portfolio.", "SEC Form 13F bulk data sets; SEC company ticker directory"),
)
