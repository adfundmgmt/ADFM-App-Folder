...
TOOL_CATALOG: Final[tuple[ToolDefinition, ...]] = (
    ...
    ToolDefinition(2, "Global Bond Monitor", "2_Global_Macro_Regime.py", "Macro Regime", "Studies potential yield exhaustion and historical top signals across U.S. rates, credit spreads and global sovereign yields, alongside dated basis-point comparisons.", "Federal Reserve and ICE BofA via FRED; OECD monthly sovereign rates via FRED"),
