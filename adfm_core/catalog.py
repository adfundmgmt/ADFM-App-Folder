...
TOOL_CATALOG: Final[tuple[ToolDefinition, ...]] = (
    ...
    ToolDefinition(18, "Catalyst Calendar", "18_Catalyst_Calendar.py", "Risk + Execution", "Maps upcoming macro catalysts, options windows, Treasury supply, earnings season, and custom event risks.", "Yahoo Finance market proxies; configured calendar data"),
