...
SIDEBAR_GUIDES: Final[dict[str, SidebarGuide]] = {
    ...
    "21_Hedge_Timer.py": SidebarGuide(("Start with the composite hedge state and its gating conditions.", "Compare trend, stress, and drawdown evidence across horizons.", "Use the post-2020 sanity check to understand historical misses and false positives."), "Treat the output as timing evidence within a hedge plan, not as a standalone trade instruction."),
