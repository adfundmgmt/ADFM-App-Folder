...
TOOL_CATALOG: Final[tuple[ToolDefinition, ...]] = (
    ...
    ToolDefinition(21, "Hedge Timing", "21_Hedge_Timer.py", "Risk + Execution", "Builds a 0-100 tactical hedge-risk score from credit, breadth, defensive rotation, volatility structure, multi-timeframe momentum, short-term breaks, and trend confirmation, then gates fresh signals when the index is already deeply oversold or well below its recent high.", "Yahoo Finance adjusted closes for S&P 500, Nasdaq-100, SPY, RSP, XLY, XLP, HYG, LQD, VIX, VIX9D, VIX3M, and VVIX"),
...
SIDEBAR_GUIDES: Final[dict[str, SidebarGuide]] = {
    ...
    "21_Hedge_Timer.py": SidebarGuide(("Start with the composite hedge state across credit, breadth, defensive rotation, volatility, multi-timeframe momentum, short-term breaks, and trend.", "Check whether a fresh signal is permitted by the 63-session drawdown and RSI oversold gates.", "Use the post-2020 S&P 500 / Nasdaq-100 sanity check to understand drawdown coverage, misses, and false positives."), "The short threshold is calibrated on post-2020 S&P 500 and Nasdaq-100 history. Treat the output as timing evidence within a hedge plan, not as a standalone trade instruction."),
