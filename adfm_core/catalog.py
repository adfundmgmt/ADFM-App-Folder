...
TOOL_CATALOG: Final[tuple[ToolDefinition, ...]] = (
    ...
    ToolDefinition(19, "Relative Volatility Lab", "19_Relative_Volatility_Lab.py", "Technicals + Analogs", "Decomposes selectable realized-volatility ratios and compares them with implied volatility, acceleration, downside, semiconductor, and breadth diagnostics.", "Yahoo Finance adjusted close history; implied-volatility indexes and ETF proxies where available"),
    ToolDefinition(20, "Options Positioning Compass", "20_Options_Positioning_Compass.py", "Flows + Sentiment", "Maps current implied-volatility richness, downside skew, term structure, and aggregate option activity across a selected universe.", "Yahoo Finance current option chains and adjusted close history"),
    ToolDefinition(21, "Position Sizing Lab", "21_Position_Sizing_Lab.py", "Risk + Catalysts", "Runs an interactive bankroll simulation using real historical holding-period outcomes, then pressure-tests conviction-based exposure against volatility, invalidation, event, tail, and liquidity risk.", "Yahoo Finance adjusted OHLCV, earnings dates, and liquid cross-asset proxies"),
    ToolDefinition(22, "Equity & Credit Underwriter", "22_Equity_Credit_Underwriter.py", "Fundamental Research", "Rebuilds filing-driven company fundamentals, current valuation, capital structure, issuer-credit ratios, debt maturities, and recent SEC events.", "SEC EDGAR Company Facts and submissions; Yahoo Finance completed-session close"),
)
