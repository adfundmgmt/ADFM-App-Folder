...
TOOL_CATALOG: Final[tuple[ToolDefinition, ...]] = (
    ...
    ToolDefinition(2, "Global Macro Regime", "2_Global_Macro_Regime_Dashboard.py", "Macro Regime", "Separates growth, inflation, rates, liquidity, and risk confirmation into a transparent cross-asset macro read, then highlights where those signals agree or conflict.", "Federal Reserve / FRED primary macro series; Yahoo Finance market proxies"),
