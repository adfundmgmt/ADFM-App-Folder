...
TOOL_CATALOG: Final[tuple[ToolDefinition, ...]] = (
    ...
    ToolDefinition(21, "ADFM Conviction & Position Sizing Lab", "21_ADFM_Conviction_Position_Sizing_Lab.py", "Risk + Catalysts", "Maps conviction to a 5%-25% exposure ceiling and reduces it using historical volatility, path risk, earnings reactions, liquidity, and explicit invalidation risk.", "Yahoo Finance adjusted OHLCV, earnings dates, and liquid cross-asset proxies"),
)
