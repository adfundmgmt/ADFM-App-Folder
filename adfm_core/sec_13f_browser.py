...
OFFICIAL_RELEASE_FALLBACKS = (
    ...
    QuarterDataset(
        slug='01sep2024-30nov2024_form13f',
        label='2024 September October November 13F',
        url='https://www.sec.gov/files/structureddata/data/form-13f-data-sets/01sep2024-30nov2024_form13f.zip',
        size_label='77.88 MB',
    ),
    QuarterDataset(
        slug='01jun2024-31aug2024_form13f',
        label='2024 June July August 13F',
        url='https://www.sec.gov/files/structureddata/data/form-13f-data-sets/01jun2024-31aug2024_form13f.zip',
        size_label='80.02 MB',
    ),
    QuarterDataset(
        slug='01mar2024-31may2024_form13f',
        label='2024 March April May 13F',
        url='https://www.sec.gov/files/structureddata/data/form-13f-data-sets/01mar2024-31may2024_form13f.zip',
        size_label='74.55 MB',
    ),
    QuarterDataset(
        slug='01jan2024-29feb2024_form13f',
        label='2024 January February 13F',
        url='https://www.sec.gov/files/structureddata/data/form-13f-data-sets/01jan2024-29feb2024_form13f.zip',
        size_label='69.66 MB',
    ),
    QuarterDataset(
        slug='2023q4_form13f',
